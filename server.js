  ...
  getAccountByEmail(email, function(data){
    if(data['error']){
      ...
      if(bcrypt.compareSync(password, data['password'])){
        ...
        session.save();
        return res.send({'sessionId': session['_id'], 'summoner': data['summoner'], 'summonerId': data['summonerId']})
      }else{
